      ...
      <Stack spacing="6">
        ...
        <Stack spacing="5">
          <FormControl isRequired id="gstNumber">
            <FormLabel htmlFor="gstNumber" color="white">GST Number</FormLabel>
            <Input
            background="white"
              type="text"
              name="gstNumber"
        ...
        <Stack spacing="5">
          <FormControl isRequired id="startup_domain">
            <FormLabel htmlFor="startup_domain" color="white">Domain</FormLabel>
            <Input
            background="white"
              type="text"
              name="startup_domain"
        ...
        <Stack spacing="5">
          <FormControl isRequired id="startup_owner">
            <FormLabel htmlFor="startup_owner" color="white">Owner Name</FormLabel>
            <Input
            background="white"
              type="text"
              name="startup_owner"
        ...
        <Stack spacing="5">
          <FormControl id="pic">
            <FormLabel htmlFor="pic" color="white">Upload your Logo</FormLabel>
