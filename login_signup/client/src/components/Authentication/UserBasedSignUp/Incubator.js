    ...
    return (
      <Stack spacing="6">
        ...
        <FormControl isRequired id="gstNumber">
          <FormLabel htmlFor="gstNumber">GST</FormLabel>
          <Input
            type="text"
            name="gstNumber"
      ...
      <Stack spacing="5">
        ...
        <Stack spacing="5">
          <FormControl isRequired id="incubator_address">
            <FormLabel htmlFor="incubator_address">Address</FormLabel>
            <Input
              type="text"
        ...
        <Stack spacing="5">
          <FormControl id="pic">
            <FormLabel htmlFor="pic">Upload Incubator's picture</FormLabel>
