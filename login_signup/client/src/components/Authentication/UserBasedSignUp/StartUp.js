      ...
      <Stack spacing="6">
        ...
        <Stack spacing="5">
          <FormControl id="cinNumber">
            <FormLabel htmlFor="cinNumber">CIN Number</FormLabel>
            <Input
              type="text"
              name="cinNumber"
        ...
        <Stack spacing="5">
          <FormControl isRequired id="startup_domain">
            <FormLabel htmlFor="startup_domain">Domain</FormLabel>
            <Input
              type="text"
              name="startup_domain"
        ...
        <Stack spacing="5">
          <FormControl isRequired id="startup_owner">
            <FormLabel htmlFor="startup_owner">Owner Name</FormLabel>
            <Input
              type="text"
              name="startup_owner"
        ...
        <Stack spacing="5">
          <FormControl id="pic">
            <FormLabel htmlFor="pic">Upload your Logo</FormLabel>
